...
const language = {
    [LANGUAGES.ES]: {
        ...
        middleAlertDescription: "Ahora hay que estar atento a las consignas que te va a decir tu capacitador y no perder la atencion a las luces que se van a encender",
    ...
    [LANGUAGES.POR]: {
        ...
        middleAlertDescription: "Agora você tem que estar atento às instruções que seu treinador vai lhe dar e não perder a atenção com as luzes que vão acender.",
